...
public class C02_StringBuilder {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("sb2.capacity() = " + sb2.capacity());//38->22 karekter ilk değer atamasında oluştu +16 default hafıza yerine
        //trimToSize()-->fazldan ayrılan capcity silinir
...
//
        ...
        System.out.println("sb3.insert(1,s,3,7)="+sb3.insert(1,s,3,7));//eel ibub:)ekir bey ->sb3 valuesini 1.index ine ekleyecek
        ...
        //istene  index teki karakteri değiştirme..
        sb4.setCharAt(6,'A');
        sb4.setCharAt(sb4.indexOf(""),':');
        System.out.println("s4="+sb4);//Nihan Qa Hanım
        ...
        System.out.println("sb3.tostring().toUpper case()"+sb3.toString().toUpperCase());///EEL İBUB:)EKİR BEY->sb3 SB stringe cevirelerek toUppercase meth calıştı
