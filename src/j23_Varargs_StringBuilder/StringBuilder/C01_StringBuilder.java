...
strBirlestir(str);//str makyaja gitti
        System.out.println("method sonrası str:"+str);//javacan->ımmutebale

//Task->50.000 tekrarlı  bir loop ilr string vestringBuilder obj run time sürelerini karşılaştırsın
        String  str1="";
