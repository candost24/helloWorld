...
public class C02_nCoples {
    public static void main(String[] args) {

        ArrayList<String>listUlke=new ArrayList<>(List.of("Alamanya","Amarigonya","ingiltere","isvec"));
        ArrayList<String>listSehir=new ArrayList<>(List.of("Münih","losAngeles","Londra","stockholm"));

        //nCopies(int,(int, Obj);-> int elamanlı bir obj den oluşan list ataması yapıyor
