...
public class C06_set {
    public static void main(String[] args) {
        ...
        System.out.println(listSehir.set(3, "angara"));//stockholm->set edieln değer print edilir
...
//listsehir.set(1,"bursa",2,"izimir");-> list te çoklu set metodu çalışmaz.buz gibi.İNTERVİEV sorusu..CTE
