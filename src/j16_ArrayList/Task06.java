...
public class Task06 {
    public static void main(String[] args) {
        /*TASK:
        kullaınıcıdan alacağınız 6 elemanlı bir dizinin
        sadece tek elemanlarını ayrı diiziye bir metodda atayarak
        yazdıırınız.
        * */
           /* TASK :
        ...
        */
        ...
        System.out.println("tekElemanlar(sayiArr) = " + tekElemanlars(sayiArr));
    ...
    private static ArrayList<Integer> tekElemanlars(int[] sayiArr) {
