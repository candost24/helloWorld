package j19_StaticVeriable;
  ...
  /*
        1.static blok yapıları static variable 'rı değer ataması yada update etmek için kulllNILIR
        2.static blok class oluşturulduğunda bütün method lardan (.main method dahil)önce çalışır
        3.birden fazla staticblock varsa yukraıdan aşağıya sıralama ile çalışır.
        * */
  class C02_StaticBlock {
