...
public class C05_ArrayIndexOutOfBoundsException {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("agam  try block  da  bu yazıyı okuduysan  exception fırlatılmadı komut sorunsuz");
        ...
        System.out.println("agam sorun handle edildi DEVAMKEEEE");// BU KOD  ÇALIŞMIŞSA PR sorunsuz kırılmadan run olmuştur
