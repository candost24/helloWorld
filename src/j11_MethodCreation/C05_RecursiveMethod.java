...
/*
* faktoriyel girlen sayıdan 1 e kadar olan tamsayıların çarpımına denir
* task girlen sayının faktoriyelini hesaplayan method create ediniz
 */
        Scanner scan=new Scanner(System.in);
        System.out.println("bir tamasayı giriniz:");
